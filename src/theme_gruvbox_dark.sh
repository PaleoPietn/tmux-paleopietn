...
theme_set_dark() {
  ...
  local _window_title_bg=${col_yellow}
  ...
  local _active_window_title_bg=${col_yellow}
  ...
  tmux_append_seto "status-right" "#[bg=${_status_right_bg},fg=${col_bg2},nobold,nounderscore,noitalics]#[bg=${col_bg2},fg=${col_yellow}] ${_right_status_x}  ${_right_status_y} #[bg=${col_bg2},fg=${_primary_color},nobold,noitalics,nounderscore]#[bg=${_primary_color},fg=${col_bg1}] "

  # current window
  local _current_window_status_format_bg=${col_bg1}
  local _current_window_bg=${col_orange}
  if [[ "$_statusbar_alpha" == "true" ]]; then _current_window_status_format_bg="default"; fi
  tmux_append_setwo "window-status-current-format" "#[bg=${_current_window_bg},fg=${col_bg1},nobold,noitalics,nounderscore]#[bg=${_current_window_bg},fg=${col_bg2}] #I #[bg=${_current_window_bg},fg=${col_bg2},bold] #W#{?window_zoomed_flag,*Z,} #{?window_end_flag,#[bg=${_current_window_status_format_bg}],#[bg=${col_bg1}]}#[fg=${_current_window_bg},nobold,noitalics,nounderscore]"

  # default window
  local _default_window_status_format_bg=${col_bg1}
  local _default_window_bg=${col_bg2}
